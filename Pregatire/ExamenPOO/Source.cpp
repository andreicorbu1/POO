...
int main()
{
	...
	*/
	...
	const char* nume[5] = { "Ana", "Vlad", "Diana", "Dan", "Paul" };
	const char* key = "Dan";
	int ans2 = Count(nume, key, 5);
	if (ans2 != 0)
	{
		std::cout << "Am regasit numele  Dan in sirul de nume de " << ans2 << " ori\n";
	}
	else std::cout << "Nu am gasit numele Dan\n";
	return 0;
}